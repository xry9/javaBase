...
//    int N;// 工作者线程数
//    N = argc > 0 ? Integer.valueOf(args[0]) : Runtime.getRuntime().availableProcessors();
//    N = 1;
//    System  .out.println(N);
//    long iterations;
//    iterations = argc > 1 ? Long.valueOf(args[1]) : 400 * 1000 * 1000L;
//
//    String taskImplClassName;
//    taskImplClassName = System.getProperty("x.task.impl");
//    if (null == taskImplClassName) {
//      taskImplClassName = "AutoPaddedCountingTask";
//    }
//
